...
public class VerifyPurchaseOrderWithUpdatedProduct {
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputStream xlfis = new FileInputStream("src/test/resources/testscriptdata.xlsx");
		...
		String contactName = row.getCell(16).toString();
		String productName = row.getCell(17).toString();
		String updatedPrice = row.getCell(18).toString();
		String organization = row.getCell(19).toString();
...
//		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//div[@class='Toastify']")));
		Thread.sleep(7000);
...
//		driver.findElement(By.xpath("//div[@class='Toastify']/descendant::button")).click();
